...
namespace SantaFeWaterSystem.Data
{
        ...
        : DbContext(options)
    {
        ...
        public DbSet<RateBracket> RateBrackets { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // 🔐 Force all DateTime values to UTC (for PostgreSQL timestamptz)
            foreach (var entity in modelBuilder.Model.GetEntityTypes())
            {
                foreach (var property in entity.GetProperties())
                {
                    ...
                    // Skip columns explicitly mapped as "date"
                    var columnType = property.GetColumnType();
                    if (columnType == "date") continue;

                    // Apply UTC conversion for DateTime and DateTime?
     ...
     new PrivacyPolicy
     {
         ...
         Version = 1,
         CreatedAt = new DateTime(2025, 8, 14, 0, 0, 0, DateTimeKind.Utc)
     }
 );
  ...
  modelBuilder.Entity<Permission>().HasData(
    ...
    new Permission { Id = 46, Name = "ManageEmailSettings", Description = "Permission to manage email settings and SMTP configuration" }
            ...
            // Seed default ratebracket
            var rateDate = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc);

            modelBuilder.Entity<RateBracket>().HasData(
                // 🔹 Residential
                new RateBracket { Id = 1, AccountType = ConsumerType.Residential, MinCubic = 0, MaxCubic = 10, RatePerCubicMeter = 0m, BaseAmount = 130m, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 2, AccountType = ConsumerType.Residential, MinCubic = 11, MaxCubic = 20, RatePerCubicMeter = 15m, BaseAmount = null, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 3, AccountType = ConsumerType.Residential, MinCubic = 21, MaxCubic = 30, RatePerCubicMeter = 17m, BaseAmount = null, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 4, AccountType = ConsumerType.Residential, MinCubic = 31, MaxCubic = null, RatePerCubicMeter = 19m, BaseAmount = null, PenaltyAmount = 0m, EffectiveDate = rateDate },

                // 🔹 Commercial
                new RateBracket { Id = 5, AccountType = ConsumerType.Commercial, MinCubic = 0, MaxCubic = 10, RatePerCubicMeter = 0m, BaseAmount = 165m, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 6, AccountType = ConsumerType.Commercial, MinCubic = 11, MaxCubic = 20, RatePerCubicMeter = 20.5m, BaseAmount = null, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 7, AccountType = ConsumerType.Commercial, MinCubic = 21, MaxCubic = 30, RatePerCubicMeter = 24.5m, BaseAmount = null, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 8, AccountType = ConsumerType.Commercial, MinCubic = 31, MaxCubic = null, RatePerCubicMeter = 29.5m, BaseAmount = null, PenaltyAmount = 0m, EffectiveDate = rateDate },

                // 🔹 Institutional
                new RateBracket { Id = 9, AccountType = ConsumerType.Institutional, MinCubic = 0, MaxCubic = 5, RatePerCubicMeter = 0m, BaseAmount = 0m, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 10, AccountType = ConsumerType.Institutional, MinCubic = 6, MaxCubic = 15, RatePerCubicMeter = 0m, BaseAmount = 130m, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 11, AccountType = ConsumerType.Institutional, MinCubic = 16, MaxCubic = 25, RatePerCubicMeter = 15m, BaseAmount = null, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 12, AccountType = ConsumerType.Institutional, MinCubic = 26, MaxCubic = 35, RatePerCubicMeter = 17m, BaseAmount = null, PenaltyAmount = 0m, EffectiveDate = rateDate },
                new RateBracket { Id = 13, AccountType = ConsumerType.Institutional, MinCubic = 36, MaxCubic = null, RatePerCubicMeter = 19m, BaseAmount = null, PenaltyAmount = 0m, EffectiveDate = rateDate },

                // 🔹 Government
                new RateBracket { Id = 14, AccountType = ConsumerType.Government, MinCubic = 0, MaxCubic = null, RatePerCubicMeter = 0m, BaseAmount = 0m, PenaltyAmount = 0m, EffectiveDate = rateDate }
            );
