...
<div style='font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; 
    ...
    <div style='text-align: center; padding-bottom: 20px; border-bottom: 1px solid #e3e3e3;'>
        ...
        <p style='margin: 0; color: #555;'>Walk-in Payment Confirmation</p>
    </div>

    <p style='font-size: 15px; color: #333;'>Hello <strong>{consumer.FullName}</strong>,</p>

    <p style='font-size: 15px; color: #333;'>
        This is to confirm that your <strong>walk-in payment</strong> has been successfully 
        recorded by our staff. Your bill is now officially marked as 
        <strong style='color: green;'>PAID</strong> in our system.
    </p>

    <div style='margin: 20px 0; padding: 15px; border-radius: 6px; background: #f4faff; 
    ...
    <p style='font-size: 15px; color: #333;'>
        You may log in anytime to your <strong>Santa Fe Water System online account</strong> 
        to view the latest billing status and payment history.
    </p>

    <p style='font-size: 15px; color: #333;'>Thank you for your payment!</p>
...
<div style='font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; 
    ...
    <div style='text-align: center; padding-bottom: 20px; border-bottom: 1px solid #e3e3e3;'>
        <h2 style='color: #0077cc; margin: 0;'>Santa Fe Water System</h2>
        <p style='margin: 0; color: #555;'>Payment Verification Notice</p>
    </div>

    <p style='font-size: 15px; color: #333;'>Hello <strong>{consumer?.FullName}</strong>,</p>

    <p style='font-size: 15px; color: #333;'>
        We’re pleased to inform you that your recent payment has been 
        <strong style='color: green;'>successfully verified</strong>.  
        Your bill is now officially marked as <strong>PAID</strong> in our system.
    </p>
    ...
    <p style='font-size: 15px; color: #333;'>
        You may log in to your <strong>Santa Fe Water System account</strong> 
        anytime to view your updated bill status and payment history.
    </p>

    <p style='font-size: 15px; color: #333;'>Thank you for your prompt payment!</p>
