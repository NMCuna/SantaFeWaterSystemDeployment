...
<div style='font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px;
    ...
    <div style='text-align: center; padding-bottom: 20px; border-bottom: 1px solid #e3e3e3;'>
        ...
        <p style='margin: 0; color: #555;'>Payment Submission Receipt</p>
    </div>

    <p style='font-size: 15px; color: #333;'>Hello <strong>{consumer.FullName}</strong>,</p>

    <p style='font-size: 15px; color: #333;'>
        We have received your <strong>payment submission</strong> for your water bill.  
        Your payment is currently <strong style='color:#d48806;'>pending verification</strong> by our admin team.
    </p>
    ...
    <p style='font-size: 15px; color: #333;'>
        You will receive an email update once your payment has been <strong>verified</strong> by our team.
    </p>
